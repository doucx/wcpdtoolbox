...
# %% auto 0
__all__ = ['open_img_cv2', 'img2xyz', 'open_img_xyz', 'xyz2img', 'show_img', 'show_img_xyz', 'img_xyz_pipe', 'PickImg',
...
def img2xyz(img:np.array)->Tensor:
...
def open_img_xyz(path)->Tensor: return img2xyz(open_img_cv2(path))
